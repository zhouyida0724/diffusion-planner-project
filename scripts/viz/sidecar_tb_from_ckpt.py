...
def main() -> None:
    ...
    p.add_argument("--num-samples", type=int, default=1, help="How many consecutive samples to visualize (starting at --sample-idx)")
    ...
    tb.add_text("meta/sample_range", f"[{start_idx}, {end_idx})", step)
